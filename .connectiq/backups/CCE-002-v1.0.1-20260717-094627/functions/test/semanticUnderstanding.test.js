...
test("detects contradictions against the customer twin", () => {
  ...
  const twin = {
    understanding: {
      currentService: {
        currentProvider: { value: "Spectrum", confidence: 0.99 },
      },
    },
  };
...
test("processes natural language and updates the customer digital twin", async () => {
  ...
  const result = await service.process({
    ...
    channel: "web",
    text: "We are a family of 5 with 2 people working from home. I pay $180 to Xfinity and need a cheaper, more reliable option this week.",
  });
