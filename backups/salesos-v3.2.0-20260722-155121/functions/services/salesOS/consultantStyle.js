...
export function discoveryAcknowledgement(profile, nextKey) {
  ...
  if (nextKey === "ask_name" && f.currentProvider && f.monthlyBill && (profile.priorities.has("price") || profile.painPoints.has("price"))) {
  ...
  if (nextKey === "ask_decision_priority" && profile.needs.has("workFromHome")) return "Since you work from home, reliability matters, but I also want to match the service to your budget and speed needs. ";
