...
export const INTENT_PATTERNS = [
  ...
  { intent: "FIND_PROVIDER", pattern: /\b(what|which)\s+(?:internet\s+|broadband\s+|service\s+)?providers?\b|\binternet\s+(?:service\s+)?(?:is\s+)?available\b|\bavailable\s+(?:internet\s+)?providers?\b|\bfind\s+(?:internet|providers?)\b/i, confidence: 0.97 },
